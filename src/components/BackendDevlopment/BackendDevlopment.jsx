import { BackendDesign, MobileDesign, processSteps, processStepsBackend } from '../../constants/List';
import { Backenddevfeatures, BackendLogo, Mobiledevfeatures, MobileLogoDev, producttFixedGrid } from '../../constants/Servicelist';
  ...
  return (
    <div className='BackendDevlopment'>
      ...
      <HeroSection
        ...
        showbutton={false}
      />
      <ApproachGrid steps={processStepsBackend} />
      <TabView data={BackendDesign} />
      <HeroSection
        subtitle="TECHNOLOGY"
      ...
      <HeroSection
        ...
        showbutton={false}
      />
      <BentoLayout data={Backenddevfeatures} />
      <HeroSection
        title="More Projects"
        showbutton={false}
      />
