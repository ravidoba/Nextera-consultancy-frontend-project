import { MobileDesign, processSteps } from '../../constants/List';
import { Mobiledevfeatures, MobileLogoDev, producttFixedGrid } from '../../constants/Servicelist';
...
const MobileDevelopment = () => {
  return (
    <div className='MobileDevelopment'>
      <TitleBar title={`Mobile Development`} />
      <HeroSection
        ...
        showbutton={false}
      />
      <ApproachGrid steps={processSteps} />
      <TabView data={MobileDesign} />
      <HeroSection
        subtitle="TECHNOLOGY"
